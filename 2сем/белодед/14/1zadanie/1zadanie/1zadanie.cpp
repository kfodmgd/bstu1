#include <iostream>//3 Изменить функцию вычисления хеш на мультипликативную функцию,  которая строится на основе формулы:  H(key) = [hashTableSize(key ∙ A mod 1)], 
//где A = (sqrt(5) - 1) / 2 = 0,6180339887499
#include "Hash.h"
using namespace std;
struct AAA
{
