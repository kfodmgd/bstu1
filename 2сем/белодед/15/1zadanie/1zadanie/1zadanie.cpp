...
const char* NML[15] = { "Аскеладд Сын Олафа", "Микаса Аккерман", "Чепелева Елизавета", "Валерий Леонтьев", "Танджиро Камудзуки",
						"Джокер Димитриади", "Нестюк Олег", "Лагами Яйт", "Шлёпа Русский кот", "ЭРЕЕЕН ЙЕЕЕГАААА",
						"Белодед Гринюк Алексеевич", "Янг Лин", "Асап Роки (на уроке)", "Лил Чича", "Пельмень Большевистский" };
